      ...
      >
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900">
            <span className="text-blue-600">Chat</span> with your Doctors
          </h1>
          <p className="text-gray-600 mt-4 text-base sm:text-lg max-w-md mx-auto md:mx-0">
            Connect seamlessly with your healthcare providers through secure, real-time messaging. Schedule appointments, share medical updates, and receive expert advice, all within our trusted platform.
          </p>
