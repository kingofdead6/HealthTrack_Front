...
// Main component for displaying tools or medicaments
export default function ToolsMedicaments({ user }) {
  // State for managing tools/medicaments data and UI
  ...
  // Trigger healthcare profile fetch
  ...
  return (
    <div className="min-h-screen bg-[#E1EEFF]">
      <div className="max-w-6xl mx-auto pt-8">
        ...
        {/* Display loading, error, or tools/medicaments */}
        {loading ? (
                ...
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      <span
                        className="text-indigo-600 font-semibold block text-lg cursor-pointer"
                        onClick={() => item.user_id && handleHealthcareClick(item.user_id._id)}
                      >
                        {item.user_id.name}
                      </span>
        ...
        {/* Popups for creating, viewing, and reporting */}
        {showCreatePopup && (
